...
namespace TradingAlpha.App.Migrations
{
    ...
    [Migration("20240223192039_Added transaction buy and sell category")]
    partial class Addedtransactionbuyandsellcategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradingAlpha.App.Models.TransactionTypes.CryptoTransaction", b =>
                {
                    b.HasBaseType("TradingAlpha.App.Models.Transaction");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasDiscriminator().HasValue("CryptoTransaction");
                });

            modelBuilder.Entity("TradingAlpha.App.Models.TransactionTypes.StockTransaction", b =>
                {
                    b.HasBaseType("TradingAlpha.App.Models.Transaction");
            ...
            modelBuilder.Entity("TradingAlpha.App.Models.Transaction", b =>
                {
                    b.HasOne("TradingAlpha.App.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
